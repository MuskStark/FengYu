 ...
 * into a {@code List<FengYuTool>}, which {@link AiToolDiscoveryConfig#aiToolCallbacks}
 ...
 * ({@code implements FengYuTool}) and requires zero edits to the discovery config —
