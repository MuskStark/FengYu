 ...
 * NOT set {@code fengyu.mode=app}, so the conditional APP-mode beans like {@code DataSourceAutoConfig}
 ...
 * upward {@code @SpringBootConfiguration} search cannot find {@code FengYuApplication} (which is in
 * {@code ai.spring}).
 */
