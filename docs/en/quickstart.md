...
The packaged backend jar lands at `FengYu/target/FengYu-4.0.0-alpha.4.jar`.
...
npm run dev       # DEFAULT: connects to an IDE-started backend at http://127.0.0.1:24056
                  ...
                  #   (build it first: ./mvnw -pl FengYu -am package -DskipTests -Drevision=4.0.0-alpha.4)
...
Release tags (`v4.0.0-alpha.4`, and later stable/beta/rc) trigger a GitHub Actions pipeline that
