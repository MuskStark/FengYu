...
Each writes `OfficialPlugins/plugin-<name>/dist-package/fan.summer.<name>-4.0.0-alpha.2.fyp`. CI builds them as a matrix in `.github/workflows/toolchain-ci.yml`.
