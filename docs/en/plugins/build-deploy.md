...
Each writes `OfficialPlugins/plugin-<name>/dist-package/fan.summer.<name>-4.0.0-alpha.1.fyp`. CI builds them as a matrix in `.github/workflows/plugin-tooling.yml`.
