...
description: Walkthrough of fan.summer.markdown (v4.0.0-alpha.2) — a text-category plugin with no permissions and no AI tools, exposing a single render method backed by MarkdownWorkerMain, and a Vuetify split-pane editor UI with live preview.
lang: en
---
