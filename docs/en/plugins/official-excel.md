...
description: Walkthrough of fan.summer.excel (v4.0.0-alpha.3) — a file-category plugin with files.read/files.write permissions, three actions (analyze, configure, split) and six aiTools, three split modes (BY_SHEET, BY_COLUMN, COMPLEX), file I/O usage, and a four-step wizard MF.
lang: en
---
