...
FengYu 核心接口、枚举、组件和内部 API 的详细参考。

## SwissKitJPlugin 接口

**位置**：`FengYu-Api/src/main/java/fan/summer/api/SwissKitJPlugin.java`
...
**位置**：`FengYu-Api/.../ToolCategory.java`
...
**位置**：`FengYu-Api/.../component/StepWizard.java`
...
**位置**：`FengYu-Api/.../log/LoggerFactory.java`
...
**位置**：`FengYu-Api/.../log/PluginLogger.java`
...
**位置**：`FengYu-Api/.../theme/Themes.java`
...
**位置**：`FengYu-Api/.../PluginContext.java`
...
**位置**：`FengYu/.../database/DatabaseInit.java`

H2 数据库位于 `.fengyu/fengyu.db`，Schema 来自 `init.sql`，MyBatis XML mapper 在 `resources/mapper/`。
