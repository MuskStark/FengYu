...
description: fan.summer.offlinepython（v4.0.0-alpha.3）详解 —— 一个 dev 类别插件，具有 files.read/files.write/network 权限，通过三栏 UI 与六个无状态 AI 工具，构建包含全部依赖的离线 Python 安装仓库（wheelhouse）。
lang: zh-CN
---
