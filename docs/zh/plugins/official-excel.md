---
title: 官方插件——Excel
description: fan.summer.excel（v4.0.0-alpha.2）讲解——一个 file 类别插件，带 files.read/files.write 权限、三个动作（analyze、configure、split）和六个 aiTools、三种拆分模式（BY_SHEET、BY_COLUMN、COMPLEX）、文件 I/O 用法，以及一个四步向导 MF。
lang: zh-CN
---
