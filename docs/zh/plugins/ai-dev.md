...
FengYu 提供了一个 **Agent Skills** 包，把 AI 编程助手变成一位 FengYu 插件专家。它熟悉
...
- 配置 `META-INF/services/fan.summer.fengyu.api.SwissKitJPlugin` 和 `maven-shade-plugin` 的
...
也可以用 `/fengyu-plugin-dev <你的请求>` 强制加载。
