...
FengYu ships an **Agent Skills** package that turns an AI coding agent into an expert
FengYu plugin author. It knows the real `SwissKitJPlugin` contract (3.2.0, 16 methods),
...
- Set up `META-INF/services/fan.summer.fengyu.api.SwissKitJPlugin` and the `maven-shade-plugin`
...
[`INSTALL.md`](https://github.com/MuskStark/FengYu/blob/main/.agents/skills/fengyu-plugin-dev/INSTALL.md).
