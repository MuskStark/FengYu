...
> **Role:** This is the spec for **how users navigate, discover, and act** in FengYu — the
...
| **Source files** | [`ui/MainWindow.java`](../../FengYu/src/main/java/fan/summer/ui/MainWindow.java) · [`ui/sidebar/Sidebar.java`](../../FengYu/src/main/java/fan/summer/ui/sidebar/Sidebar.java) · [`ui/content/ContentArea.java`](../../FengYu/src/main/java/fan/summer/ui/content/ContentArea.java) · [`ui/content/ToolCard.java`](../../FengYu/src/main/java/fan/summer/ui/content/ToolCard.java) · [`ui/content/DetailPanel.java`](../../FengYu/src/main/java/fan/summer/ui/content/DetailPanel.java) · [`ui/store/PluginStoreUi.java`](../../FengYu/src/main/java/fan/summer/ui/store/PluginStoreUi.java) |
| **Notification API** | [`SkNotification`](../../FengYu-Api/src/main/java/fan/summer/api/component/SkNotification.java) (`.sk-notif-*`) |
...
FengYu is a **toolbox**: the user opens it, finds a tool, uses it, and leaves. Every
...
Three things make the FengYu interaction model what it is:
...
host wires this in [`MainWindow`](../../FengYu/src/main/java/fan/summer/ui/MainWindow.java):
...
[`PluginStoreUi`](../../FengYu/src/main/java/fan/summer/ui/store/PluginStoreUi.java)
...
FengYu forms (built from `.sk-field` / `.sk-combo` / `.sk-checkbox`) follow conservative
validation timing:
...
> **Notification API** ([`SkNotification`](../../FengYu-Api/src/main/java/fan/summer/api/component/SkNotification.java)):
...
When wiring interactions in FengYu (host or plugin), you **MUST**:
...
**Source files:**
- [`ui/MainWindow.java`](../../FengYu/src/main/java/fan/summer/ui/MainWindow.java) — launch/back/uninstall wiring, view cache
- [`ui/sidebar/Sidebar.java`](../../FengYu/src/main/java/fan/summer/ui/sidebar/Sidebar.java) — category select, `sidebar.collapsed` persistence
- [`ui/content/ContentArea.java`](../../FengYu/src/main/java/fan/summer/ui/content/ContentArea.java) — search, `showPage`/`crossFadeTo`, grid filter
- [`ui/content/ToolCard.java`](../../FengYu/src/main/java/fan/summer/ui/content/ToolCard.java) — `onSelect` callback, running pulse
- [`ui/content/DetailPanel.java`](../../FengYu/src/main/java/fan/summer/ui/content/DetailPanel.java) — slide-in, `showUninstallConfirm`
