...
/**
 * One entry of a conversation workspace's flat file listing (workspace-relative paths); the
 * chat view assembles the expandable tree client-side.
 */
...
/** File listing of an attached coding workspace, bounded by the server's walk caps. */
...
/**
 * One workspace file fetched for the preview pane. Exactly one of `content` (text), `binary`,
 * or `tooLarge` is meaningful — the server mirrors the read_file tool's caps.
 */
