...
export const md3Light: ThemeDefinition = {
  ...
  colors: {
    ...
    // Vuetify component styles also reference these tokens (snackbar text, field labels…).
...
export const md3Dark: ThemeDefinition = {
  ...
  colors: {
    ...
    // See the note in md3Light: without these, Vuetify fills the on-* pairs with black and
    // e.g. snackbar text becomes invisible on dark surfaces.
