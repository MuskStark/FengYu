...
export function simulatorHtml({ iframeSrc, manifest }: SimulatorHtmlOptions): string {
  ...
  // Permissions Policy is decided when the iframe is created. Mirror production PluginView:
