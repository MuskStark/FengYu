...
|---|---|---|
| Windows 10/11 (64-bit) | `SwissKit-3.0.0-rc.3-windows.zip` | Extract then double-click `SwissKit.exe` |
| Linux x64 | `SwissKit-3.0.0-rc.3-linux.zip` | Extract then run `./run.sh` |
| macOS Apple Silicon (M1/M2/M3) | `SwissKit-3.0.0-rc.3-macos-apple-silicon.zip` | Extract then double-click `SwissKit.app` |
...
```bash
java -Dstore.url=http://localhost:8888/plugins/store.json -jar SwissKit/target/SwissKitJ-3.0.0-rc.3.jar
```
