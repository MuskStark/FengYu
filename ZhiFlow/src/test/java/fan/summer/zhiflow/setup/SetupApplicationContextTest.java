 ...
 *
 * <p>SETUP mode is a minimal context: it scans only {@code fan.summer.zhiflow.setup} +
 * {@code fan.summer.zhiflow.web}, and excludes the APP-only controllers via
 ...
 *
 * <p>Mirrors {@code HeadlessIntegrationTest}'s approach for the APP-mode ({@code AiApplication})
