...
import fan.summer.zhiflow.buildintool.dev.HashCalculatorPlugin;
import fan.summer.zhiflow.buildintool.dev.JsonFormatterPlugin;
import fan.summer.zhiflow.buildintool.email.EmailPlugin;
import fan.summer.zhiflow.buildintool.emailarchive.EmailArchivePlugin;
import fan.summer.zhiflow.buildintool.excelsplitter.ExcelSplitterPlugin;
import fan.summer.zhiflow.buildintool.pdftool.PdfToolPlugin;
import fan.summer.zhiflow.buildintool.image.ColorConverterPlugin;
import fan.summer.zhiflow.buildintool.text.MarkdownEditorPlugin;
