...
/**
 * MyBatis mapper interface for {@link fan.summer.zhiflow.database.entity.setting.email.EmailAddressBookEntity}.
 *
 * <p>Provides CRUD operations and a count query for email address book entries.
 *
 * @see fan.summer.zhiflow.database.entity.setting.email.EmailAddressBookEntity
 */
