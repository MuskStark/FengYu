...
ZhiFlow shell and must follow these exactly. (Docs site: `https://muskstark.github.io/ZhiFlow/#/ui-design/...`)

| Topic | Spec doc (online) | Rule in one line |
|---|---|---|
| Color tokens & contrast | [05 Theme & Color System](https://muskstark.github.io/ZhiFlow/#/ui-design/05-theme-color-system) | `-sk-*` tokens / `.sk-*` classes only; no hex; check the contrast matrix |
| Components & CSS | [03 Component Library](https://muskstark.github.io/ZhiFlow/#/ui-design/03-component-library) | Use the `.sk-*` classes as specified; names below are the *only* valid ones |
| JavaFX coding + naming | [02 JavaFX Implementation](https://muskstark.github.io/ZhiFlow/#/ui-design/02-javafx-implementation) | Code-is-the-UI; single class; `sk-` prefix BEM-lite |
| Layout / typography / spacing / radius | [01 Design System](https://muskstark.github.io/ZhiFlow/#/ui-design/01-design-system) | Global font stack; 11/12/13/13.5/15 px sizes; 4 px grid; 6/8/10/999 px radii |
| Motion | [07 Animation Guidelines](https://muskstark.github.io/ZhiFlow/#/ui-design/07-animation-guidelines) | Token durations/easings; feedback ≤ 300 ms; never animate theme switch |
| Interaction | [04 Interaction Guidelines](https://muskstark.github.io/ZhiFlow/#/ui-design/04-interaction-guidelines) | Cache view; cross-fade page switch; confirm destructive; four-state feedback |
| Accessibility | [08 Accessibility Guide](https://muskstark.github.io/ZhiFlow/#/ui-design/08-accessibility-guide) | ≥ 4.5:1 contrast; not-by-color-alone; keyboard-reachable; Esc closes |

**Design philosophy (from [01](https://muskstark.github.io/ZhiFlow/#/ui-design/01-design-system)):**
...
[05 §contrast](https://muskstark.github.io/ZhiFlow/#/ui-design/05-theme-color-system).
...
- `getMdiIcon()` returns the **bare** name (no `mdi-` prefix); verify a name exists in
  [`mdi-codemap.properties`](https://github.com/MuskStark/ZhiFlow/blob/main/ZhiFlow-Api/src/main/resources/fonts/mdi-codemap.properties) before using it.
