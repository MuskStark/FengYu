...
public class KeepAwakeUi {
    ...
    private void initComponents() {
        ...
        // VIOLATION (M4): legacy .glass-* class reference, should use .sk-*
        Label legacyLabel = new Label();
        legacyLabel.getStyleClass().add("glass-card");
        // VIOLATION (M5): banned setPrefWidth(Double.MAX_VALUE) pattern
        legacyLabel.setPrefWidth(Double.MAX_VALUE);
