...
/**
 * Workbench — the canonical FengYu plugin composition.
 *
 * This is the visual fixture Playwright screenshots and the template Task 5
 * copies into the CLI generator. It composes the library's shell, header, file
 ...
 * {@link useFengYuClient}, so the e2e harness must provide one.
 *
 * The task list is seeded with deterministic rows so screenshots are stable.
 */
import { ref } from 'vue'
import {
  FyFilePicker,
...
/** Deterministic seed so visual baselines are reproducible. */
